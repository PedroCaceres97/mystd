...
#define MY_VECTOR_FN_CREATE     MY_CONCAT2(MY_VECTOR_FN_PREFIX, _Create)
...
MY_RWLOCK_DECLARES(MY_VECTOR_STRUCT, vec, MY_VECTOR_FN_PREFIX)
...
void                    MY_VECTOR_FN_RESIZE     (MY_VECTOR_STRUCT* vec, size_t size) {
    ...
    MY_REALLOC(vec->data, MY_VECTOR_DATA_TYPE, vec->data, vec->capacity);
