...
#define MY_LIST_NODE_FN_PREFIX      MY_LIST_NODE_STRUCT
...
#define MY_LIST_NODE_FN_CREATE      MY_CONCAT2(MY_LIST_NODE_FN_PREFIX, _Create)
#define MY_LIST_NODE_FN_DUPLICATE   MY_CONCAT2(MY_LIST_NODE_FN_PREFIX, _Duplicate)
#define MY_LIST_NODE_FN_DESTROY     MY_CONCAT2(MY_LIST_NODE_FN_PREFIX, _Destroy)

#define MY_LIST_NODE_FN_SET         MY_CONCAT2(MY_LIST_NODE_FN_PREFIX, _Set)
#define MY_LIST_NODE_FN_GET         MY_CONCAT2(MY_LIST_NODE_FN_PREFIX, _Get)
#define MY_LIST_NODE_FN_NEXT        MY_CONCAT2(MY_LIST_NODE_FN_PREFIX, _Next)
#define MY_LIST_NODE_FN_PREV        MY_CONCAT2(MY_LIST_NODE_FN_PREFIX, _Prev)
#define MY_LIST_NODE_FN_LIST        MY_CONCAT2(MY_LIST_NODE_FN_PREFIX, _List)
/** @endcond */
